...
(custom-set-variables
 ...
 '(package-selected-packages
   '(auto-complete company counsel dash f flycheck google-translate groovy-mode js2-mode markdown-mode popup rjsx-mode tide typescript-mode vterm web-mode websocket yaml-mode ivy swiper markdown-preview-mode sokoban typit dockerfile-mode prettier-js nginx-mode js-doc json-mode rainbow-delimiters rainbow-mode))
